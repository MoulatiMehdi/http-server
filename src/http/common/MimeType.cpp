...
MimeType::MimeType()
{
    ...
    MimeType::map["jpeg"]  = "image/jpeg";
    MimeType::map["jpg"]   = "image/jpeg";
    ...
    MimeType::map["svg"]  = "image/svg+xml";
    MimeType::map["svgz"] = "image/svg+xml";
    MimeType::map["tiff"] = "image/tiff";
    MimeType::map["tif"]  = "image/tiff";
    ...
    MimeType::map["jar"] = "application/java-archive";
    MimeType::map["war"] = "application/java-archive";
    MimeType::map["ear"] = "application/java-archive";
    ...
    MimeType::map["ps"]   = "application/postscript";
    MimeType::map["eps"]  = "application/postscript";
    MimeType::map["ai"]   = "application/postscript";
    ...
    MimeType::map["pl"]      = "application/x-perl";
    MimeType::map["pm"]      = "application/x-perl";
    MimeType::map["prc"]     = "application/x-pilot";
    MimeType::map["pdb"]     = "application/x-pilot";
    ...
    MimeType::map["tcl"]     = "application/x-tcl";
    MimeType::map["tk"]      = "application/x-tcl";
    MimeType::map["der"]     = "application/x-x509-ca-cert";
    MimeType::map["pem"]     = "application/x-x509-ca-cert";
    MimeType::map["crt"]     = "application/x-x509-ca-cert";
    ...
    MimeType::map["exe"] = "application/octet-stream";
    MimeType::map["bin"] = "application/octet-stream";
    MimeType::map["dll"] = "application/octet-stream";
    MimeType::map["deb"] = "application/octet-stream";
    MimeType::map["dmg"] = "application/octet-stream";
    MimeType::map["iso"] = "application/octet-stream";
    MimeType::map["img"] = "application/octet-stream";
    MimeType::map["msi"] = "application/octet-stream";
    MimeType::map["msp"] = "application/octet-stream";
    MimeType::map["msm"] = "application/octet-stream";

    MimeType::map["mid"]  = "audio/midi";
    MimeType::map["midi"] = "audio/midi";
    MimeType::map["kar"]  = "audio/midi";
    MimeType::map["mp3"]  = "audio/mpeg";
    MimeType::map["ogg"]  = "audio/ogg";
    MimeType::map["m4a"]  = "audio/x-m4a";
    MimeType::map["ra"]   = "audio/x-realaudio";

    MimeType::map["3gpp"] = "video/3gpp";
    MimeType::map["3gp"]  = "video/3gpp";
    MimeType::map["ts"]   = "video/mp2t";
    MimeType::map["mp4"]  = "video/mp4";
    MimeType::map["mpeg"] = "video/mpeg";
    MimeType::map["mpg"]  = "video/mpeg";
    ...
    MimeType::map["asx"]  = "video/x-ms-asf";
    MimeType::map["asf"]  = "video/x-ms-asf";
